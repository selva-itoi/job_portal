        ...
        <div class="container px-5 py-12 mx-auto">
            ...
            <div class="-my-6">
                @foreach($jobs as $Jobs)
                    <a
                        href="{{ route('jobs.show', $Jobs->slug) }}"
                    ...
                    >
                        <div class="md:w-16 md:mb-0 mb-6 mr-4 flex-shrink-0 flex flex-col">
                            <img src="/storage/{{$Jobs->logo }}" class="w-16 h-16 rounded-full object-cover">
                        </div>
                        <div class="md:w-1/2 mr-8 flex flex-col items-start justify-center">
                            <h2 class="text-xl font-bold text-gray-900 title-font mb-1">{{ $Jobs->title }}</h2>
                            <p class="leading-relaxed text-gray-900">{{ $Jobs->company }} &mdash; <span class="text-gray-600">{{ $Jobs->location }}</span></p>
                        </div>
                        ...
                        <span class="md:flex-grow flex flex-col items-end justify-center">
                            ...
                            <span><strong class="text-bold">{{ $Jobs->clicks()->count() }}</strong> Apply Button Clicks</span>
                        </span>
                    </a>
                @endforeach
            </div>
